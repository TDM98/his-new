...
namespace UserAccountsProxy
{
    ...
    public interface IUserAccounts
    {
        ...
        [OperationContract(AsyncPattern = true)]
        IAsyncResult BeginEditStaffPCLResultParamResponsibilities(long StaffID, bool IsDoctor, string ListPCLResultParamImpID, AsyncCallback callback, object state);
