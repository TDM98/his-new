...
namespace ConfigurationManagerService
{
    ...
    public class UserAccountsService : eHCMS.WCFServiceCustomHeader, IUserAccounts
    {
        ...
        public bool EditStaffPCLResultParamResponsibilities(long StaffID, bool IsDoctor, string ListPCLResultParamImpID)
        {
            try
            {
                return aEMR.DataAccessLayer.Providers.UserAccounts.Instance.EditStaffPCLResultParamResponsibilities(StaffID, IsDoctor, ListPCLResultParamImpID);
            }
            catch (Exception ex)
            {
